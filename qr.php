    ...
    <body>
        ...
        <div style="padding-left:16px">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>Silahkan Upload Foto QR Code</h4>
                        <hr>
                        <form method="post" enctype="multipart/form-data" action="file-upload3.php">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="hapus2.php?id_gambar=<?php echo $data['id_gambar']; ?>&gambar=<?php echo $data['gambar']; ?>" onclick="konfirmasi()" class="btn btn-danger" role="button">Hapus</a>
                                            </td>
                                        </tr>
