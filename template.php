    ...
    <body>
        ...
        <div style="padding-left:16px">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h4>Silahkan Upload Foto Template</h4>
                        <hr>
                        <form method="post" enctype="multipart/form-data" action="file-upload2.php">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width='10%' cellspacing="10">
                            ...
                            <tbody>
                                ...
                                $sql = "select * from gambar1 order by id_gambar desc";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus1.php?id_gambar=<?php echo $data['id_gambar']; ?>&gambar=<?php echo $data['gambar']; ?>" onclick="konfirmasi()" class="btn btn-danger" role="button">Hapus</a>
                                        </td>
                                    </tr>
